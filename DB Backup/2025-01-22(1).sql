...
INSERT INTO `challenges` VALUES (1,NULL,NULL,'Dale un toque a tu perfil','10',1000,'Cambia tu imagen de perfil',NULL,'1','2024-12-29 20:56:36',NULL),(2,NULL,NULL,'Invita a tu primer referido','20',2000,NULL,NULL,'1','2024-12-29 20:57:58',NULL),(3,NULL,NULL,'Sube tu primera factura','50',5000,NULL,NULL,'1','2025-01-11 01:40:14',NULL),(4,NULL,NULL,'Parcicipar en un sorteo','10',1000,'Parcicipar en un sorteo','Felicidades por tu primera insignia de Sorteo','1','2025-01-12 20:30:20',NULL),(5,NULL,NULL,'Regalar X Pikcoins a un amigo ',NULL,NULL,NULL,NULL,NULL,'2025-01-15 13:45:53',NULL),(6,NULL,NULL,'Reclamar Pikcoins obtenidos por referidos',NULL,NULL,NULL,NULL,NULL,'2025-01-15 13:46:20',NULL),(7,NULL,NULL,'Compartir un producto a un amigo',NULL,NULL,NULL,'',NULL,'2025-01-17 19:36:20',NULL),(8,NULL,NULL,'Guardar un productos en favoritos',NULL,NULL,NULL,'',NULL,'2025-01-17 19:36:21',NULL),(9,NULL,NULL,'Loyalty',NULL,NULL,'Al completar el carton te puedes llevar un servicio ¡Gratis!',NULL,NULL,'2025-01-23 02:44:22',NULL);
/*!40000 ALTER TABLE `challenges` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `challenges_detail`
--

DROP TABLE IF EXISTS `challenges_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `challenges_detail` (
...
--
-- Dumping data for table `challenges_detail`
--

LOCK TABLES `challenges_detail` WRITE;
/*!40000 ALTER TABLE `challenges_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `challenges_detail` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `competitions` VALUES (1,120,'Act 4 Sorteo de Navidad','act-4-sorteo-de-navidad','Liberación de cupos el sábado 27 de OCT','PS5 de Disco',32500,32,'2024-12-31 22:53:14'),(2,131,'Cadena Oro Italiano 18K 60cm','cadena-oro-italiano-18k-60cm','Cadena Oro Italiano 18K 60cm',NULL,12000,100,'2025-01-23 03:24:17');
...
--
-- Dumping routines for database 'pikplay'
--
/*!50003 DROP PROCEDURE IF EXISTS `getCompetitionMembers` */;
...
DELIMITER ;;
CREATE DEFINER=`remote_user`@`%` PROCEDURE `getCompetitionMembers`(
...
-- Dump completed on 2025-01-22 22:55:38
